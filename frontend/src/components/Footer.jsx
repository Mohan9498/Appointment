...
function Footer({ onOpenModal }) {
  return (
    <footer className="bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 text-black dark:text-white pt-12 pb-4 border-t border-gray-200/50 dark:border-white/[0.06]">

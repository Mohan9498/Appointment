...
function Services() {
  ...
  return (
    <section className="relative py-10 md:py-24 overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 dark:bg-slate-900/50">
      ...
      <div className="relative w-full px-4 md:px-6">
        ...
        <div className="text-center mb-8 md:mb-16">
          <span className="inline-block px-3 py-1 md:px-4 md:py-1.5 rounded-full text-xs font-semibold tracking-wider uppercase bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-300 mb-3 md:mb-4">
            Our Services
          </span>
          <h2 className="text-2xl md:text-5xl font-extrabold tracking-tight text-gray-900 dark:text-white">
            Our <span className="text-gradient">Services</span>
          </h2>

          <p className="text-gray-500 dark:text-gray-400 mt-3 md:mt-4 max-w-xl mx-auto text-sm md:text-base leading-relaxed">

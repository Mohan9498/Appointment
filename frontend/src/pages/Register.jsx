              ...
              <form onSubmit={handleRegister} className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3.5 outline-none focus:border-slate-900 focus:bg-white"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3.5 pr-12 outline-none focus:border-slate-900 focus:bg-white"
                      required
                    />
